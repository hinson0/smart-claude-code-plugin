...
- Codex: `$github-skills-pdf`
- Claude Code: `/fuzz:github-skills-pdf`
...
Users may invoke `$github-skills-pdf --notes 2` or
`$github-skills-pdf --notes 4`. Omitting `--notes` inserts no note pages. Resolve
