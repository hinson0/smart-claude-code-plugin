...
| `/smart:show [<path>.md]` | 現在の会話の成果物（または Markdown ファイル）を自己完結型ゼロ JS の HTML レビューページにレンダリングし、`.smart/pages/` に書き出してブラウザで開く。レイアウトレシピ 3 種：plan-review / explainer / report |
